          ...
          <div className="card h-100">
            ...
            >
              ...
              <button
                className="carousel-control-prev"
                type="button"
                data-bs-target="#carouselAvantGarden"
                data-bs-slide="prev"
              >
                <span
                  className="carousel-control-prev-icon"
              ...
              <button
                className="carousel-control-next"
                type="button"
                data-bs-target="#carouselAvant Garden"
                data-bs-slide="next"
              >
                <span
                  className="carousel-control-next-icon"
          ...
          <div className="card h-100">
            ...
            >
              ...
              <button
                className="carousel-control-prev"
                type="button"
                data-bs-target="#carouselLadybird"
                data-bs-slide="prev"
              >
                <span
                  className="carousel-control-prev-icon"
        ...
        <div className="col-lg-4 col-md-6 mb-4">
          <div className="card h-100">
            ...
            <div className="card-body">
              <h2>Dirt Candy</h2>
              <a
                href="https://www.dirtcandynyc.com/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <p>
