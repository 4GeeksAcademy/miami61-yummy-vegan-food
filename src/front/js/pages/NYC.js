...
export const NYC = () => {
    ...
    return (
        ...
        <br></br>
            <p><i class="fa-solid fa-face-smile"></i>: 4.4  <i class="fa-solid fa-star"></i>
        ...
        ><i class="class="fa-solid fa-map-pin></i>
           ...
           <i class="fa-regular fa-heart btn btn-danger"></i>
            ...
            <a 
              ...
              rel="noopener noreferrer"
            ><i class="fa-solid fa-shop"></i></a>
            <p><i class="fa-solid fa-face-smile"></i>: 4.6<i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i>(644 reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $50–100</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
           ...
           <i class="fa-regular fa-heart btn btn-danger"></i>
            ...
            <p><i class="fa-solid fa-face-smile"></i>: 4.5 <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i> (772 reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $30–50</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
        ...
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i> (731 reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $30–50</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
        ...
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i> (1.7K reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $50–100</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
           ...
           <i class="fa-regular fa-heart btn btn-danger"></i>
            ...
            <p><i class="fa-solid fa-face-smile"></i>: 4.7  <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i>(943 reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $10–20</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
        ...
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i>(1.2K reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $100+</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
           ...
           <i class="fa-regular fa-heart btn btn-danger"></i>
            ...
            <p><i class="fa-solid fa-face-smile"></i>: 4.8  <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i>(945 reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $10–20</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
        ...
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i>(1.1K reviews)</p>
        ...
        <i class="fa-solid fa-star"></i>
        <i class="fa-solid fa-star"></i>
        <i class="fa-regular fa-star-half-stroke"></i>(985 reviews)</p>
            <p><i class="fa-solid fa-hand-holding-dollar"></i>: $30–50</p>
            <p><i class="fa-solid fa-bowl-rice"></i> Vegan</p>
